...
class GoogleOAuth2(OAuthProvider):
    ...
    request_token_params = {'scope': 'https://www.googleapis.com/auth/userinfo.email https://www.googleapis.com/auth/userinfo.profile',  # noqa: E501
                            'response_type': 'code'}
...
class CasAuth():
    ...
    def verify_ticket(self, ticket, service):
        ...
        url = (urljoin(config.CAS_SERVER, '/cas/proxyValidate')
               + '?' + urlencode(params))
